...
import 'package:foodtrip_riders_app/global/global.dart';
import 'package:foodtrip_riders_app/mainScreens/parcel_delivering_screen.dart';
import 'package:foodtrip_riders_app/maps/map_utils.dart';
      ...
      body: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: ()
            {
              //show location from rider to seller
            ...
            child: Center(
              child: InkWell(
                onTap: ()
                {
                  ...
                  //confirm that rider left seller

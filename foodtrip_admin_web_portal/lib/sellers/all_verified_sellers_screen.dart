...
import 'package:foodtrip_admin_web_portal/widgets/simple_app_bar.dart';
...
class AllVerifiedSellersScreen extends StatefulWidget
{
  ...
  @override
  _AllVerifiedSellersScreenState createState() => _AllVerifiedSellersScreenState();
}
...
class _AllVerifiedSellersScreenState extends State<AllVerifiedSellersScreen>
{
  ...
  void initState() {
    ...
    FirebaseFirestore.instance
        ...
        .get().then((allActivatedUsers)
    {
      setState(() {
        allSellers = allActivatedUsers;
      });
    });
  }
  ...
  Widget build(BuildContext context)
  {
    ...
    return Scaffold(
      appBar: SimpleAppBar(title: "Activated Sellers Accounts",),
      body: Center(
        child: Container(

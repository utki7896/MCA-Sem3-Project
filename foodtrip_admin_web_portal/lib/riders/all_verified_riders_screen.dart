...
class AllVerifiedRidersScreen extends StatefulWidget
{
  ...
  @override
  _AllVerifiedRidersScreenState createState() => _AllVerifiedRidersScreenState();
}
...
class _AllVerifiedRidersScreenState extends State<AllVerifiedRidersScreen>
{
  ...
  void initState() {
    ...
    FirebaseFirestore.instance
        ...
        .get().then((allActivatedRiders)
    {
      setState(() {
        allRiders = allActivatedRiders;
      });
    });
  }
  ...
  Widget build(BuildContext context)
  {
    ...
    return Scaffold(
      appBar: SimpleAppBar(title: "Activated Riders Accounts",),
      body: Center(
        child: Container(
